...
(function($) {
    ...
    $.fn.DualListBox = function(paramOptions, selected) {
        return this.each(function () {
            ...
            selected = $.extend([{}], selected); //alert(selected);
    ...
    function addListeners(options) {
        ...
        //alert("UnSelected COunt:" +unselected.find('option').length); alert("Selected Count:" +selected.find('option').length);
    ...
    function createDualListBox(options) {
        ...
        $(options.parentElement).addClass('row').append(
                ...
                '       <select id="unselectedtask" class="unselected" style="height: 200px; width: 100%;" multiple></select>' +
                '   </div>' +
                ...
                '       <select id="selectedTask" class="selected" style="height: 200px; width: 100%;" multiple></select>' +
                '   </div>');
    ...
    function createVerticalButtons(copyAllBtn) {
        return '   <div class="col-md-2 center-block" style="margin-top: ' + (copyAllBtn ? '80px' : '130px') +'">' +
            (copyAllBtn ? '       <button type="button" class="btn btn-default col-md-8 col-md-offset-2 atr" data-type="atr" style="margin-bottom: 10px;visibility:hidden;"><span class="glyphicon glyphicon-list"></span> <span class="glyphicon glyphicon-chevron-right"></span></button>' : '') +
            '       <button type="button" id="btnRight" class="btn btn-default col-md-8 col-md-offset-2 str" data-type="str" style="margin-bottom: 20px;" disabled><span class="glyphicon glyphicon-chevron-right"></span></button>' +
            '       <button type="button" id="btnLeft" class="btn btn-default col-md-8 col-md-offset-2 stl" data-type="stl" style="margin-bottom: 10px;" disabled><span class="glyphicon glyphicon-chevron-left"></span></button>' +
            (copyAllBtn ? '       <button type="button" class="btn btn-default col-md-8 col-md-offset-2 atl" data-type="atl" style="margin-bottom: 10px;visibility:hidden;"><span class="glyphicon glyphicon-chevron-left"></span> <span class="glyphicon glyphicon-list"></span></button>' : '') +
            '   </div>';
    }
    ...
    $.fn.filterByText = function(textBox, timeout, parentElement) {
        return this.each(function() {
            ...
            $(select).find('option').each(function() {
                options.push({ value: $(this).val(), text: $(this).text() }); //alert(options.push({ value: $(this).val(), text: $(this).text() }));
            });
